...
DROP FUNCTION IF EXISTS create_referral(INTEGER, INTEGER);
DROP FUNCTION IF EXISTS process_referral_rewards(JSON, NUMERIC, JSON);
DROP FUNCTION IF EXISTS increment_team_volume(INTEGER, NUMERIC);
DROP FUNCTION IF EXISTS create_increment_referrals_function();
...
DROP FUNCTION IF EXISTS add_stk_balance(INTEGER, NUMERIC, TEXT);
