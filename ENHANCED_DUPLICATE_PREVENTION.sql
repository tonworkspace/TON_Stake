-- Enhanced Duplicate Prevention for Referral System
-- This ensures comprehensive protection against duplicate referrals

-- 1. Ensure unique constraint exists (if not already added)
DO $$
BEGIN
    IF NOT EXISTS (
...
-- 2. Create a referral attempts tracking table for better analytics
...
-- 3. Enhanced referral creation function with better duplicate prevention
...
-- 4. Create a function to check referral status
...
-- 5. Create a function to get referral analytics
...
-- 7. Create a view for easy referral monitoring
